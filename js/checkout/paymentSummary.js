...
import { deliveryOptionPrice } from '../../data/deliveryOptions.js';
...
export function renderPaymentSummary(){
    ...
    cart.forEach(item => {
       ...
       shipping += deliveryOptionPrice(item);
       
    });
    const totalBeforeTaxCents = productPriceCents + shipping;
    estimatedTax = totalBeforeTaxCents * 0.1;
